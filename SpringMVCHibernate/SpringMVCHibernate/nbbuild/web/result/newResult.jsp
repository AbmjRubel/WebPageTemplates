...
<table  bgcolor="lightblue" width="750" height="500" align="center" style="border-collapse: collapse;" border="1" bordercolor="#006699" >
	<tr>
		<td align="center"><h3>New Result Form</h3></td>
	</tr>
	<tr valign="top" align="center">
    <td align="center">
 		<form:form action="saveResult.do" method="post" commandName="newResult">
				...
				<table width="500" style="border-collapse: collapse;" border="0" bordercolor="#006699" cellspacing="2" cellpadding="2">	
					...
					<tr>
						...
						&nbsp;&nbsp;
						<input type="button"  value="Back" onclick="javascript:goResult('viewAllResult.do');">
						</td>
					</tr>					
				</table>			
		</form:form>
